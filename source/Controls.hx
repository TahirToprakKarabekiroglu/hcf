...
class Controls extends FlxActionSet
{
	...
	public function setKeyboardScheme(scheme:KeyboardScheme = Solo, reset = true)
	{
		if (reset)
			removeKeyboard();
		...
		{
			case Solo:
				inline bindKeys(Control.NOTE_UP, [FlxKey.fromString(FlxG.save.data.coin100), FlxKey.UP]);
				inline bindKeys(Control.NOTE_DOWN, [FlxKey.fromString(FlxG.save.data.coin25), FlxKey.DOWN]);
				inline bindKeys(Control.NOTE_LEFT, [FlxKey.fromString(FlxG.save.data.coin5), FlxKey.LEFT]);
				inline bindKeys(Control.NOTE_RIGHT, [FlxKey.fromString(FlxG.save.data.coin500), FlxKey.RIGHT]);
			case Duo(true):
